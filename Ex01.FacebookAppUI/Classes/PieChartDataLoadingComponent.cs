...
namespace Ex02.FacebookAppLogic.Classes
{
    ...
    public sealed class PieChartDataLoadingComponent<T>
    {
        ...
        // CTOR
        public PieChartDataLoadingComponent(Chart i_PieChartToLoad, FacebookObjectCollection<T> i_FacebookObjectCollection, string i_PieChartTitle, List<PropertyCounter> i_PropertyCounterList, string i_PieChartId)
        {
